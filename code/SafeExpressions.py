...
"""A Safe Page Template Expression Engine

Page Template-specific implementation of TALES, with handlers
for Python expressions, string literals, and paths.

This modification of PageTemplates.Expressions for use with Nooron
hardcodes the use of a restricted execution environment for python
code.  Much code was just nabbed, holus bolus, because Expressions
...
def getEngine():
    global _engine
    if _engine is None:
        from SafeIterator import Iterator
...
def always_validate(o1,o2,n,o):
    # /usr/local/zope/Zope-2.5.1/lib/python/AccessControl/SecurityManager.py
    #print "validate() ",o1,o2,n,o
    return 1
